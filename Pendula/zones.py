...
def _explain(comp: np.ndarray, drivers: dict, weights: dict) -> str:
    ...
    labels = {
        ...
        "auto_struktura": "prelom dna",
        "termoklina_na_dnu": "termoklina legla na dno",
        "bistrina": "bistra voda",
        "pridnena_temp": "povoljna pridnena temperatura",
        "uz_obalu": "uzak priobalni pojas",
        "slope": "nagib dna",
        "calm_sea": "mirno more",
        "moon": "mjesecina",
        "diel": "zora/sumrak",
