...
# --------------------------------------------------------------- GLAVNI POSAO
def build_predictors(*, sst, sst_lag3, sst_lag7, chl_surf, chl3d, depth_levels,
                     theta, salinity, u, v, mld, static, lats, lons,
    ...
    # --- vertikala
    z_thermo, thermo_strength = fields.thermocline(theta, depth_levels)
    z_dcm, dcm_ratio = fields.dcm_depth(chl3d, depth_levels)
